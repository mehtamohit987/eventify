...
class EventSerializer(DocumentSerializer):
	class Meta:
		model 	= Event
		fields 	= ('id', 'title', 'start_timestamp', 'end_timestamp', 'description', 'organizer', 'event_category', 'address', 'city', 'country', 'postal_code', 'coordinates', 'image_thumbnail_url', 'info_url', 'num_fav', 'django_id', 'django_ct')
		read_only_fields=('id', )
		# depth = 2
...
class EventSearchSerializer(serializers.Serializer):
	...
	num_fav				= serializers.IntegerField()