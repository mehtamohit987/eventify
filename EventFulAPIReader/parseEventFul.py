...
for date in xrange(11,29):
	print date
	for page_num in xrange(1,2):#250):
		events = api.call('/events/search', t='201508'+str(date)+'00-201508'+str(date+1)+'00', page_size=20, page_number=page_num)# 100
